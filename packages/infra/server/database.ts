...
export const adminClient = drizzle(adminPostgresClient, config);

// Создаем RLS клиент с контекстом пользователя
export const createRlsClient = (userId?: string) => drizzle(createRlsPostgresClient(userId), config); 